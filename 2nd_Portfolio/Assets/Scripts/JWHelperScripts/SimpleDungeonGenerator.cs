...
public class SimpleDungeonGenerator : MonoBehaviour
{
    ...
    private void Generate(InputAction.CallbackContext obj)
    {
        ...
        dungeonData.Rooms.Add(GenerateRectangularRoomAt(Vector2.zero, roomSize));
        dungeonData.Rooms.Add(GenerateRectangularRoomAt(Vector2Int.zero + Vector2Int.right * 15, roomSize));
        dungeonData.Rooms.Add(GenerateRectangularRoomAt(Vector2Int.zero + Vector2Int.down * 15, roomSize));

        dungeonData.Path.UnionWith(CreateStraightCorridor(Vector2Int.zero, Vector2Int.zero + Vector2Int.right * 15));
        dungeonData.Path.UnionWith(CreateStraightCorridor(Vector2Int.zero, Vector2Int.zero + Vector2Int.down * 15));
